    ...
    <div class='md:flex md:flex-row gap-2 mb-4 items-start'>
        <div class="flex-1 gray-card mb-4">
            ...
            <ul class="list-disc pl-5 space-y-1">
                ...
                <li>
                    當生育地類型為「08（天然林）」、「09（人工林）」或「19（野化果樹林）」時，系統會自動新增對應的地被樣區「88（天然林-地被）」、「99（人工林-地被）」或「77（野化果樹林-地被）」，並共用相同的小樣方編號。
                    <ul class="list-['✳️'] list-outside pl-5 mt-1 space-y-1">
                        <li><b>請務必先輸入主生育地的資料</b>，系統才會產生對應的地被樣區。</li>
                        <li>主生育地「08」、「09」、「19」的取樣面積固定為 5×5；對應地被「88」、「99」、「77」固定為 2×5。</li>
                        <li>為確保地被樣區與森林樣區的小樣方編號能正確對應，地被類型「88」、「99」、「77」將鎖定「生育地類型」與「小樣方編號」欄位，不可進行修改。</li>
