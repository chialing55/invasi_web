    ...
    <div class="md:flex gap-2 items-center flex-wrap">
      ...
      @foreach([0,45,90,135,180,225,270,315] as $deg)
        <div class="flex items-center gap-1">
          ...
          <input id="light_{{ $deg }}" name="light_{{ $deg }}" type="number" wire:model.defer="subPlotEnvForm.light_{{ $deg }}" class="border border-gray-300 px-1 py-0.5 w-16 " placeholder="0-100">
        </div>
      @endforeach
    </div>
