  <div class="md:flex md:flex-col gap-2 text-sm">
      ...
      <div class="md:flex gap-2 items-center">
          ...
          <input id="date" name="date" type="date" wire:model.defer="subPlotEnvForm.date"
              class="border border-gray-300 px-2 py-1 w-48 {{ $addclass }}" {{ $readonly }}>

          <label for="investigator" class="w-20 text-right">調查者</label>
          <input id="investigator" name="investigator" type="text" wire:model.defer="subPlotEnvForm.investigator"
              class="border border-gray-300 px-2 py-1 w-40 {{ $addclass }}" placeholder="請填本名" {{ $readonly }}>

          <label for="recorder" class="w-20 text-right">紀錄者</label>
          <input id="recorder" name="recorder" type="text" wire:model.defer="subPlotEnvForm.recorder"
              class="border border-gray-300 px-2 py-1 w-40 {{ $addclass }}" placeholder="請填本名" {{ $readonly }}>
      </div>
      ...
      <div class="md:flex gap-2 items-center">
          ...
          <input id="dd97_y" name="dd97_y" type="number" step="any" wire:model.defer="subPlotEnvForm.dd97_y"
              class="border border-gray-300 px-2 py-1 w-32 {{ $addclass }}" placeholder="20 - 27"
              {{ $readonly }}>

          <label for="gps_error" class="w-24 text-right">座標誤差</label>
          <input id="gps_error" name="gps_error" type="number" step="any"
              wire:model.defer="subPlotEnvForm.gps_error"
              class="border border-gray-300 px-2 py-1 w-24 {{ $addclass }}" placeholder="0 - 10"
              {{ $readonly }}>
      </div>

      <div class="md:flex gap-2 items-center">
          <label for="plot" class="w-24 text-right">樣區編號</label>
          <input id="plot" name="plot" type="text" wire:model.defer="subPlotEnvForm.plot"
              class="border border-gray-300 px-2 py-1 w-40 bg-gray-100 text-gray-600" readonly>
          ...
          <input id="subplot_id" name="subplot_id" type="text" wire:model.defer="subPlotEnvForm.subplot_id"
              class="border border-gray-300 px-2 py-1 w-24 {{ $addclass }}" maxlength="2" placeholder="01-50"
              {{ $readonly }}>
      </div>
      ...
      <div class="md:flex gap-4 items-center">
          ...
          <label for="area_1x10"><input id="area_1x10" type="radio" wire:model.defer="subPlotEnvForm.subplot_area"
                  name="subplot_area" value="1"> 1 x 10</label>
          <label for="area_2x5"><input id="area_2x5" type="radio" wire:model.defer="subPlotEnvForm.subplot_area"
                  name="subplot_area" value="2"> 2 x 5</label>
          <label for="area_5x5"><input id="area_5x5" type="radio" wire:model.defer="subPlotEnvForm.subplot_area"
                  name="subplot_area" value="3"> 5 x 5</label>
      </div>
    ...
    <div class="md:flex gap-4 items-center">
      ...
      <div class="md:flex gap-2 items-center">
          ...
          <input id="elevation" name="elevation" type="number" step="any"
              wire:model.defer="subPlotEnvForm.elevation"
              class="border border-gray-300 px-2 py-1 w-24 {{ $addclass }}" placeholder="0-5000"
              {{ $readonly }}>
          ...
          <input id="slope" name="slope" type="number" step="1"
              ...
              class="border border-gray-300 px-2 py-1 w-30 {{ $addclass }}" placeholder="-1(未調查), 0-90"
              {{ $readonly }}>
          ...
          <input id="aspect" name="aspect" type="number" step="1"
              ...
              class="border border-gray-300 px-2 py-1 w-30 {{ $addclass }}" placeholder="-1(未調查), 0-359"
              {{ $readonly }}>
      </div>
      ...
      <div class="md:flex gap-2 items-center">
          ...
          <input id="photo_id" name="photo_id" type="text" wire:model.defer="subPlotEnvForm.photo_id"
              class="border border-gray-300 px-2 py-1 w-64">

          <label for="env_description" class="w-24 mb-1 text-right">環境描述</label>
          <textarea id="env_description" name="env_description" wire:model.defer="subPlotEnvForm.env_description"
              rows="1" class="w-64 border border-gray-300"></textarea>
      </div>
      <!-- 舊樣區編號 -->
